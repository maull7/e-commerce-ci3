                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= base_url('auth/registrasi_admin'); ?>" method="post">

                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="nama" name="nama" placeholder="Your Name" value="<?= set_value('nama'); ?>">
